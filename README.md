...
The [goalplanner-share-mcp](https://github.com/AKAddons/goalplanner-share-mcp) server lets an AI assistant build import codes from plain English — *"make me an Inferno prep plan with the slayer unlocks I need"* → a previewed, validated share code with every goal auto-tracking. Every code in this guide was generated by it.
...
- **Not installed** — nothing appears; the menu stays clean if you don't use Loadout Lab.
